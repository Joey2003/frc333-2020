...
public class BTMain 
{
    ...
    public void autonomous(RobotChassis m_chassis, RobotShooter m_shooter, RobotTurret m_turret, RobotHood m_hood)
    {
		...
		catch (FileNotFoundException e)
		{
			...
			if (player != null)
			{
				player.play(m_chassis, m_shooter, m_turret, m_hood);
			}
		...
		if(player != null)
		{
			player.end(m_chassis, m_shooter, m_turret, m_hood);
		}
    	
    }
	
    public void operatorControl(Joystick joystick, RobotChassis m_chassis, RobotShooter m_shooter, RobotTurret m_turret, RobotHood m_hood)
    {
		...
		catch (IOException e) 
		{
    		...
    		if (joystick.getRawButton(RobotMap.PlayerButton.RECORD))
			{
			...
			if (isRecording)
			{
    			try
    			{
    				...
    				if(recorder != null)
    				{
    					recorder.record(m_chassis, m_shooter, m_turret, m_hood);
    				}
